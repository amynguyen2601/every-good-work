    ...
    let keys = Object.keys(carousel);
        ...
        keys.forEach((key) => {
            ...
            const manageSlides = (direction) => {
                ...
                let setDirection = direction === 'prev' ? -1 : 1; //if direction === 'prev' {setDorectopn = -1} else {setDirection = 1}
...
// document = html file
// addEventListener('DOMContentLoaded')... at the moment that the page start -> doing sth
// document.getElementsByClassName('carousel') : anything have the Class of "carosel" in html file
